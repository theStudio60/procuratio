...
<?php if( have_rows('option-group_conseil','option') ): 
  while( have_rows('option-group_conseil','option') ): the_row();  
    if( have_rows('group_control') ): 
      ...
      ?>
        <section id="control" class="section d-flex   py-3 py-lg-5 bg-dark"  data-aos="slide-up" data-aos-anchor-placement="bottom-center">
...
<?php if( have_rows('option-group_conseil','option') ): 
  while( have_rows('option-group_conseil','option') ): the_row();  
    if( have_rows('group_mandats') ): 
      ...
      ?>
        <section id="mandats" class="section bg-white  py-3 py-lg-5"   data-aos="slide-up" data-aos-anchor-placement="bottom-center">
