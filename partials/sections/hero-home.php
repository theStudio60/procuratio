...
<?php } ;?>  
  <section  
    id="hero"
    class="hero hero--home h-100 bg-light"
    style="background: url('<?= $backgroundImg[0]; ?>');"
  >  
  <div class="hero__overlay hero__overlay--default" >
    <div class="hero__container mx-auto">
      <div class="hero__row">
          ...
          <div class="my-auto " style=" "> 
            <div class="p-2" data-aos="fade-right" data-aos-duration="800">
              ...
              <?php if ($content) :  ?>
                ...
                <br>
              <?php endif;?>
              <div class="w-100 d-md-flex text-center text-md-left">
