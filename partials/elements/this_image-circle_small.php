...
//
?>
  <img src="<?php echo esc_url($thisImage_url); ?>" alt="<?php echo esc_attr($thisImage_alt); ?>" width="100%" class="img-circle my-2" style="border-radius:50%;max-width:64px;height:64px"/>
<?php endif; ?>